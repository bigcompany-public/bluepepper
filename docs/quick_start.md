...
From here, it is advised to download to download the demo project (see next section), or to create a few assets/shots in the entityCreator. Once this is done, you can play around in the Browser to see what you can do.

![quickstart entitycreator](img/quickstart_entitycreator.jpg)


## Downloading The Demo Project (Optional)
